...
EXTERN void emu_live_view_start(const char* address, int port);
EXTERN void emu_live_view_stop(void);
EXTERN bool emu_live_view_is_running(void);
EXTERN void emu_live_view_publish(void);
